/**
@desc Ensure the game does not get stuck with the error popup window.
*/
function olympus_initialize_headless(){
...
*/
function olympus_run(function_to_add_tests_and_hooks, olympus_suite_options = new Olympus_Suite_Options()) {
	//Use copy
	olympus_suite_options = new Olympus_Suite_Options(olympus_suite_options);
	//Feather ignore GM1041 Need to support union types
	if script_exists(function_to_add_tests_and_hooks){
		var original_script_name = script_get_name(function_to_add_tests_and_hooks);
		olympus_suite_options.original_script_name = original_script_name;
	}		
	var function_to_add_tests_and_hooks_with_context = method(self, function_to_add_tests_and_hooks);
	return new _Olympus_Suite(function_to_add_tests_and_hooks_with_context, olympus_suite_options);
}
...
@typedef {struct} Olympus_Suite_Options 
	...
	@property {string} [description=""] A text description of the suite.
	@property {string} [suite_name=""] Override the name of the suite.
	@property {function} [function_to_call_on_suite_finish=undefined] Function to execute when all tests have concluded.
	@property {function} [function_to_call_on_suite_start=undefined] Function to execute when before tests start.
	
*/
function Olympus_Suite_Options(options = {}) constructor{
	...
	description = ""
	suite_name = "unnamed_suite"
	function_to_call_on_suite_finish = undefined;
	function_to_call_on_suite_start = undefined;
...
#region olympus_suite_options
	...
	#macro olympus_suite_options_description description
	#macro olympus_suite_options_suite_name suite_name
	#macro olympus_suite_options_callback_on_suite_finish function_to_call_on_suite_finish
	#macro olympus_suite_options_callback_on_suite_start function_to_call_on_suite_start
#endregion
...
@typedef {struct} Olympus_Test_Options 
	...
	@property {string} [description=""] A text description of the test.
 */
...
#region olympus_test_options
	...
	#macro olympus_test_options_description description
#endregion
...
@param {any} [...] 
 */
function xolympus_run() {
	show_debug_message("Skipped running the suite");
}
...
function olympus_add_hook_before_suite_start(function_to_execute, context = undefined){
	var function_with_setup = _olympus_hook_set_up(function_to_execute, context);
	_olympus_suite_ref.function_to_call_on_suite_start = function_with_setup;
}
...
function olympus_add_hook_after_suite_finish(function_to_execute, context = undefined){
	var function_with_setup = _olympus_hook_set_up(function_to_execute, context);
	_olympus_suite_ref.function_to_call_on_suite_finish = function_with_setup;
}

/** 
@desc Set the run_id of the current suite.
@param {string} run_id
*/
function olympus_set_current_suite_id(run_id){
	global._olympus_suite_manager.current_suite._my_summary_manager_ref.get_summary().run_id = run_id;
}

/** 
@desc Return the run_id of the current suite. 
@return {string}
*/
function olympus_get_current_suite_id(){
	return global._olympus_suite_manager.current_suite._my_summary_manager_ref.get_summary().run_id;
}
 ...
 */
#macro olympus_test_resolve (_olympus_get_resolve_function_handle())

/**
@desc Calls the rejection function of the current test
@arg {*} [args...] Can take any arguments
 */
#macro olympus_test_reject (_olympus_get_reject_function_handle())
